...
type AuthenticationServiceClient interface {
	...
	ValidateToken(ctx context.Context, in *Token, opts ...grpc.CallOption) (*TokenValidationResponse, error)
}
...
func (c *authenticationServiceClient) Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/grpc.authentication.jwt.AuthenticationService/Login", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authenticationServiceClient) ValidateToken(ctx context.Context, in *Token, opts ...grpc.CallOption) (*TokenValidationResponse, error) {
	out := new(TokenValidationResponse)
	err := c.cc.Invoke(ctx, "/grpc.authentication.jwt.AuthenticationService/ValidateToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthenticationServiceServer) ValidateToken(context.Context, *Token) (*TokenValidationResponse, error) {
...
func _AuthenticationService_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.authentication.jwt.AuthenticationService/Login",
	}
...
func _AuthenticationService_ValidateToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.authentication.jwt.AuthenticationService/ValidateToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var AuthenticationService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "grpc.authentication.jwt.AuthenticationService",
